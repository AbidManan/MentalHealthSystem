                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                FirebaseAuth.getInstance().getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        FirebaseDatabase.getInstance().getReference().child("UserDetails").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                ...
                                                ReusableFunctionsAndObjects.showMessageAlert(PatientRegister.this, "Network Error", "Could'nt registe "+e.getMessage(),"OK", (byte) 0);
                                            }
                                        });
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        progressDialog.dismiss();
                                        ReusableFunctionsAndObjects.showMessageAlert(PatientRegister.this, "Network Error", "Could'nt register,t"+e.getMessage(),"OK", (byte) 0);
                                    }
                                });
                            } else {
                            try {
                                ...
                                progressDialog.dismiss();
                                ReusableFunctionsAndObjects.showMessageAlert(PatientRegister.this, "Network Error", "Could'nt register"+e.getMessage(),"OK", (byte) 0);
                            }
                        }
